<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px 30px 30px 0","fontSize":"14px","color":"#666","background":"#f4f8fb"}'>
		...
		>
			<template >
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'" label="报损单号" prop="baosundanhao">
					<el-input v-model="ruleForm.baosundanhao" placeholder="报损单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.baosundanhao" label="报损单号" prop="baosundanhao">
					<el-input v-model="ruleForm.baosundanhao" placeholder="报损单号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="报损时间" prop="baosunshijian">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.baosunshijian" 
						type="date"
						:readonly="ro.baosunshijian"
						placeholder="报损时间"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.baosunshijian" label="报损时间" prop="baosunshijian">
					<el-input v-model="ruleForm.baosunshijian" placeholder="报损时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="报损原因" prop="baosunyuanyin">
					<el-input v-model="ruleForm.baosunyuanyin" placeholder="报损原因" clearable  :readonly="ro.baosunyuanyin"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' v-else class="input" label="报损原因" prop="baosunyuanyin">
					<el-input v-model="ruleForm.baosunyuanyin" placeholder="报损原因" readonly></el-input>
				</el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.baosunshijian = this.getCurDate()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='baosundanhao'){
							this.ruleForm.baosundanhao = obj[o];
							this.ro.baosundanhao = true;
							continue;
						}
						if(o=='wuzimingcheng'){
						...
						if(o=='baosunyuanyin'){
							this.ruleForm.baosunyuanyin = obj[o];
							this.ro.baosunyuanyin = true;
							continue;
						}
    ...
    // 提交
    onSubmit() {
		if(this.ruleForm.baosundanhao) {
			this.ruleForm.baosundanhao = String(this.ruleForm.baosundanhao)
		}
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `wuzibaosun/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.wuzibaosunCrossAddOrUpdateFlag = false;
											this.parent.search();
