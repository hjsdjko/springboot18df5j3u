<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px 30px 30px 0","fontSize":"14px","color":"#666","background":"#f4f8fb"}'>
		...
		>
			<template >
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'" label="采购单号" prop="caigoudanhao">
					<el-input v-model="ruleForm.caigoudanhao" placeholder="采购单号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.caigoudanhao" label="采购单号" prop="caigoudanhao">
					<el-input v-model="ruleForm.caigoudanhao" placeholder="采购单号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'"  label="物资分类" prop="wuzifenlei">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="采购时间" prop="caigoushijian">
					<el-date-picker
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.caigoushijian" label="采购时间" prop="caigoushijian">
					<el-input v-model="ruleForm.caigoushijian" placeholder="采购时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="采购金额" prop="caigoujine">
					<el-input v-model.number="ruleForm.caigoujine" placeholder="采购金额" clearable  :readonly="ro.caigoujine"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' v-else class="input" label="采购金额" prop="caigoujine">
					<el-input v-model="ruleForm.caigoujine" placeholder="采购金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="采购原因" prop="caigouyuanyin">
					<el-input v-model="ruleForm.caigouyuanyin" placeholder="采购原因" clearable  :readonly="ro.caigouyuanyin"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' v-else class="input" label="采购原因" prop="caigouyuanyin">
					<el-input v-model="ruleForm.caigouyuanyin" placeholder="采购原因" readonly></el-input>
				</el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.caigoushijian = this.getCurDate()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='caigouyuanyin'){
							this.ruleForm.caigouyuanyin = obj[o];
							this.ro.caigouyuanyin = true;
							continue;
						}
						if(o=='wuzitupian'){
    ...
    // 提交
    onSubmit() {
		if(this.ruleForm.caigoudanhao) {
			this.ruleForm.caigoudanhao = String(this.ruleForm.caigoudanhao)
		}
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `caigouxuqiu/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.caigouxuqiuCrossAddOrUpdateFlag = false;
											this.parent.search();
